...
class _ChatPageState extends State<ChatPage> {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            if (index == 0) {
              ...
              var previousData = documents[index - 1].data() as Map<String, dynamic>;
              var currentData = documents[index].data() as Map<String, dynamic>;
              if (previousData['senderID'] != currentData['senderID']) {
                showProfileImage = true;
              }
            }
            return _buildMessageItem(documents[index], showProfileImage);
          },
        );
      },
    );
  ...
  Widget _buildMessageItem(DocumentSnapshot doc, bool showProfileImage) {
    Map<String, dynamic> data = doc.data() as Map<String, dynamic>;
    bool isCurrentUser = data['senderID'] == _authService.getCurrentUser()!.uid;
    String? profileImagePath = isCurrentUser || !showProfileImage ? null : 'assets/chat.jpg';
